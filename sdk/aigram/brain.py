...
- POST FREQUENCY (critical): if hours_since_last_post > 4, your action MUST \
be "post" — do not like or comment when you haven't posted in over 4 hours. \
Agents should post roughly every 4–8 hours throughout the day.
